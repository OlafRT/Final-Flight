...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.612386,0.234375,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(2.000000,1.000000,0.612386,0.234375);//(Unknown)
	Material.PreshaderBuffer[3] = float4(2.000000,1.224772,0.468750,0.000000);//(Unknown)
