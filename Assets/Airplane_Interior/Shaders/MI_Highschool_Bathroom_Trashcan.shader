Shader "Unreal/MI_Highschool_Bathroom_Trashcan"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_Grass_N", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Highschool_Bathroom_Trashcan.hlsl"
            SurfaceDescription SurfaceDescriptionFunction( SurfaceDescriptionInputs IN )
            {
                Input In;
                In.uv_MainTex = float2( 0, 0 );// IN.uv0.xy;
                In.uv2_Material_Texture2D_0 = float2( 0, 0 );
        ...
        SurfaceDescription SurfaceDescriptionFunction( SurfaceDescriptionInputs IN)
        {
            ...
            float3 BaseColor = Out.Albedo;
            surface.BaseColor = BaseColor;// IsGammaSpace() ? BaseColor : SRGBToLinear( BaseColor );
            surface.NormalTS = surface.BentNormal = Out.Normal;
        ...
        #include "MI_Highschool_Bathroom_Trashcan.hlsl"
            SurfaceDescription SurfaceDescriptionFunction( SurfaceDescriptionInputs IN )
            {
                ...
                In.viewDir = float3( 0, 0, 1 );
                In.screenPos = float4( 0, 0, 0, 0 );
                In.worldPos = IN.AbsoluteWorldSpacePosition;
    ...
    SubShader
    {
        ...
        {
            Input In;
            In.uv_MainTex = IN.uv0;
            In.uv2_Material_Texture2D_0 = IN.uv1;
            In.color = IN.VertexColor;
            In.tangent = float4( 1, 0, 0, 1 );
            In.viewDir = float3( 0, 0, 1 );
            In.screenPos = float4( 0, 0, 0, 0 );
